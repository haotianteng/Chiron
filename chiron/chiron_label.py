    ...
    with h5py.File(FLAGS.output,"a") as hdf5_record :
        ...
        for name in os.listdir(FLAGS.segments):
            ...
            if read_index is not None:
                ...
                tmp_event,tmp_event_length,tmp_label,tmp_label_length = get_label(ref,align,signals,lens,segments)
                event+=tmp_event
...
parser.add_argument('-s','--segments',default='/home/haotianteng/UQ/deepBNS/data/Lambda_R9.4/segments',help="File folder of the segment files",required=True)
parser.add_argument('-r','--reference',default='/home/haotianteng/UQ/deepBNS/data/Lambda_R9.4/Reference/lambda.fasta',help="Reference genome.",required=True)
