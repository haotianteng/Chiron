...
"""
#todo: can this whole script be removed? seems it was temporary and there are ALOT of bugs in it
import sys
from chiron.chiron_input import biglist
import h5py
import mappy as mp
import os
import argparse
...
#todo: what is the point of this function? Can it be removed?
        ...
        for name in os.listdir(FLAGS.segments):
            ...
            if name.endswith('.fastq') or name.endswith('.fasta'):
                ...
                try:
                    ...
                    print
                    strand_name + " is not find int the alignments.\n"
                    continue
                except:
                    print
